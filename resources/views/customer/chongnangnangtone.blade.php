                ...
                <div class="block2">
                    ...
                    <div class="block2-txt flex-w flex-t p-t-14">
                        <div class="block2-txt-child1 flex-col-l ">
                            ...
                            <form class="cart clearfix d-flex align-items-center" action="{{url('/save_cart')}}" method="post">
                                @csrf
                                    <div class="quantity" style="display: block;margin-left: auto;margin-right: auto;margin-top: -10px;">
                                        ...
                                        <button type="submit" name="submit" style="height: 30px;display:block;     line-height: normal;" class="btn alazea-btn ml-15">Thêm vào giỏ</button>
